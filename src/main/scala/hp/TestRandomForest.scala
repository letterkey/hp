...
//        }
        ...
        /** Step 1
          ...
          * ... ...
          */
            val path = "/Users/yinmuyang/git/fittime/hp-randomforest/data/test/data_banknote_authentication.txt"
        val parsedRDD = sc.textFile(path).map(_.split(",")).map(eachRow => {
        ...
        /**
          ...
          */
        predictionResultDF.select("f0","f1","f2","f3","label","predictedLabel").show(100,false)
